...
st.info("Here are AI-generated tips to help you interpret your data and drive improvements:")
ai_insights = [
    "Your revenue has outpaced the industry average 4 out of the last 7 days.",
    "Expenses are slightly higher than peers. Consider reviewing major cost drivers for optimization.",
    "Customer growth is steady, but a targeted marketing push could accelerate gains.",
    "Automate recurring financial tasks to improve margin and team productivity.",
    "Watch for increased variance in expenses – set an alert if over 10% weekly.",
    "Try segmenting customers and offering loyalty rewards to boost retention.",
]
for tip in ai_insights:
    if "outpaced" in tip:
        st.success(tip)
    elif "higher than peers" in tip or "variance" in tip:
        st.warning(tip)
    else:
        st.info(tip)
